...
def analyze_video(video_path):
    ...
    if not cap.isOpened():
        return None, "Gagal membuka file video"
    ...
    while True:
        ...
        if results.multi_face_landmarks:
            for face_id, face_landmarks in enumerate(results.multi_face_landmarks):
                ...
                eye_history.setdefault((face_id, "left"),  []).append(ear_left)
                eye_history.setdefault((face_id, "right"), []).append(ear_right)
    ...
    return {
        "total_eyes":            eyes_analyzed,
        "perfect_blinks_total":  perfect_blinks,
        "partial_blinks_total":  partial_events,
        "avg_perfect_per_eye":   perfect_blinks / eyes_analyzed,
        "avg_partial_per_eye":   partial_events / eyes_analyzed,
